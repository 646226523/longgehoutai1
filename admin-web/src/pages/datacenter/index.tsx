...
import {
  TrophyOutlined, RiseOutlined, TeamOutlined, FireOutlined, ThunderboltOutlined,
  CloudOutlined, CheckCircleOutlined, SyncOutlined, ReloadOutlined, FullscreenOutlined,
  FullscreenExitOutlined, ApartmentOutlined, EnvironmentOutlined, SendOutlined,
  FlagOutlined, ClockCircleOutlined, FundOutlined, StockOutlined, AimOutlined,
  SafetyCertificateOutlined, ShareAltOutlined, DownloadOutlined, RocketOutlined, StopOutlined,
} from '@ant-design/icons';
import dayjs from 'dayjs';

// ===== Extracted modules =====
import type { AuctionItem, RaceItem, FlightData, CityDetail, ProvinceDetailData, MapMode } from './types';
import { COLORS, provinceTop10, provinceData, cityLevelData, cityToProvince, cityPositions, statusLabelMap } from './constants';
import { pigeonPhotos, mockAuctions, mockRaces, flightStatuses, generateFlightData } from './mockData';
import { getBarChartOption, getLineChartOption, getMapOption, getProvinceMapOption, loadProvinceGeoJSON } from './charts';
